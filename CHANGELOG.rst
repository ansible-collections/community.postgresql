...
- postgresql_set - the ``db`` alias of the ``login_db`` option has been removed. Use the ``login_db`` option instead (https://github.com/ansible-collections/community.postgresql/issues/831).
